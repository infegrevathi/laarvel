...
<head>
    ...
    {{-- Datepicker --}}
    <link rel="stylesheet" href="{{ asset('backend/date/date-picker.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/date/jquery-ui.css') }}" />
...
<body class="sidebar-dark">
    ...
    {{-- DatePicker --}}
    <script src="{{ asset('backend/date/jquery-ui.js') }}"></script>
    <script>
