...
<div class="page-content">
    <div class="row">
        <div class="col-lg-12 mb-3 d-flex justify-content-between">
            <h4 class="font-weight-bold d-flex align-items-center">Edit Centre</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-block">
                <div class="card-body">
                    <div class="acc-edit">
                        <form action="{{ route('center.update', $center->id) }}" method="POST" id="center_form"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="center" id="center"
                                        placeholder="Enter Centre Name" value="{{ $center->sender }}" autocomplete="off">
                                    @error('center')
